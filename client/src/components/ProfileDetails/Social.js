...
function Social() {
    ...
    const inputList = (
        <Grid container columnSpacing={2} rowSpacing={2}>
            <Grid item container>
                <Typography variant="span" component="div">Social Media Details</Typography>
            </Grid>
