...
import {updateAchievement, removeAchievement} from '../../store/userProfileSlice';
...
function Achievements() {
    ...
    const achievementsList = useSelector(state=> state.profileInfo.profile.achievements);
    ...
    const inputList = (
        <Grid container columnSpacing={2} rowSpacing={2}>
            <Grid item container>
                <Typography variant="span" component="div">Achievement Details</Typography>
            </Grid>
    ...
    return (
        <Grid container
            ...
            <Grid item container sx={{marginBottom:'1rem'}}>
                {/* Education List */}
                {
                    achievementsList && achievementsList.map((item, i)=> (
