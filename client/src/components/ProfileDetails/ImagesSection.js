...
function Images() {
    ...
    const imagesList = useSelector(state=> state.profileInfo.profile.extra.personalImages);
    ...
    const inputList = (
        <Grid container columnSpacing={2} rowSpacing={2}>
            <Grid item container>
                <Typography variant="span" component="div">Image Details</Typography>
            </Grid>
    ...
    return (
        <Grid container
            ...
            <Grid item container sx={{marginBottom:'1rem'}}>
                {/* Education List */}
                {
                    imagesList && imagesList.map((item, i)=> (
