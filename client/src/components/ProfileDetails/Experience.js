import { Button, Card, CardActionArea, CardActions, CardContent, Checkbox, FormControl, FormControlLabel, Grid, TextField, Typography } from '@mui/material';
import React, {useState} from 'react';
import {useDispatch, useSelector} from 'react-redux';
import Spinner from '../Spinner/Spinner';
import {makeStyles} from '@mui/styles';
import axios from '../../axios';
import {removeExperience, updateExperience} from '../../store/userProfileSlice';
...
function Experience() {
    ...
    const experienceList = useSelector(state=> state.profileInfo.profile.experience);
    ...
    const inputList = (
        <Grid container columnSpacing={2} rowSpacing={2}>
            <Grid item container>
                <Typography variant="span" component="div">Experience Details</Typography>
            </Grid>
    ...
    return (
        <Grid container
            ...
            <Grid item container sx={{marginBottom:'1rem'}}>
                {/* Education List */}
                {
                    experienceList && experienceList.map((item, i)=> (
                            ...
                            <Card className={classes.Card}>
                                <CardActionArea>
                                    <CardContent>
                                        ...
                                        <Typography variant="div" >
                                            <Typography variant="span">Years Of Experience:</Typography>
                                            <Typography variant='h6'
                                                gutterBottom
                                                component="div">
                                                    {item.yoe}
